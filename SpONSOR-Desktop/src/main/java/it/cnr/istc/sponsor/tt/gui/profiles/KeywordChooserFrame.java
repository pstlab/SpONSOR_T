 ...
 */
public class KeywordChooserFrame extends javax.swing.JFrame implements MQTTListener {

    private Keyword key = null;
    private SingleKeywordPanel parentPanel = null;
    private boolean avoid = false;
    /**
     * Creates new form KeywordChooserFrame
     */
    public KeywordChooserFrame() {
        initComponents();
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(jTextField_key, javax.swing.GroupLayout.DEFAULT_SIZE, 182, Short.MAX_VALUE))
...
//        this.keywordListModel1.addElement(key);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(KeywordChooserFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new KeywordChooserFrame().setVisible(true);
            }
        });
    }
