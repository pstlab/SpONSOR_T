 ...
 */
public class TableImageGeneratorPanel extends javax.swing.JPanel {
    ...
    private final String[] weekLabels = new String[]{LUN, MAR, MER, GIO, VEN, SAB, DOM};
    private int miniRowHeight = 64;
     ...
     */
    public TableImageGeneratorPanel() {
        initComponents();
