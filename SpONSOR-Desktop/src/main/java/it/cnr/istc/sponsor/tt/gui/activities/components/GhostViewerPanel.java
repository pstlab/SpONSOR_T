...
import it.cnr.istc.sponsor.tt.abstracts.RoundedBorderGhosts;
 ...
 */
public class GhostViewerPanel extends javax.swing.JPanel implements MQTTListener, GuiEventListener {

    RoundedBorderGhosts roundBorder = new RoundedBorderGhosts(Color.BLACK, 10);

    /**
     * Creates new form PeopleWorkingViewerPanel
     */
    public GhostViewerPanel() {
        initComponents();
...
//            this.jLabel1.setText(""+TrainerManager.getInstance().getPeople().size());
            ...
            Logger.getLogger(GhostViewerPanel.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void initComponents() {
        ...
        jLabel2.setText("  Assegnazioni/Disponibilità  ");
        jLabel2.setToolTipText("Assegnazioni desiderate nel piano corrente / Disponibilità totale dichiarata da tutti gli utenti (non dormienti)");

        GroupLayout layout = new GroupLayout(this);
        this.setLayout(layout);
        layout.setHorizontalGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING)
            .addComponent(jLabel2, GroupLayout.DEFAULT_SIZE, 146, Short.MAX_VALUE)
...
//        this.jLabel1.repaint();
    ...
    public void newActivityTurn(ActivityTurn turn) {
        ...
        for (Activity activity : activities) {
            ...
            for (ActivityTurn activityTurn : activityTurns) {
                jobs += activityTurn.getRequiredProfiles().size();
            }
        }
        roundBorder.setJobs(jobs);
        this.jLabel1.invalidate();
        this.jLabel1.repaint();
    }
    ...
    public void removeActivityEvent(Activity activity) {
        ...
        for (Activity a : activities) {
            List<ActivityTurn> activityTurns = a.getActivityTurns();
            for (ActivityTurn activityTurn : activityTurns) {
                jobs += activityTurn.getRequiredProfiles().size();
            }
        }
    ...
    public void newDormient(long id) {
         roundBorder.setGhosts(TrainerManager.getInstance().getGhostNumber());
        this.jLabel1.invalidate();
        this.jLabel1.repaint();
